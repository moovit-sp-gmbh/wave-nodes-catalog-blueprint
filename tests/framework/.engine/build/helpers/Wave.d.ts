...
/**
 * The General class provides access to general node methods and properties.
 */
...
/**
 * The Logger class provides access to the nodes logger to update the nodes progress and status message.
 */
...
declare class FileAndFolderHelper {
     ...
     * @param duplicateFileOption Option defining how to handle an already existing file with the same name
     * @param progressCallback (Optional) callback function that will be called whenever there is measurable progress (max 1/s)
     ...
     */
    copyFile(srcFilePath: string, destFilePath: string, duplicateFileOption: DuplicateFileOption, progressCallback?: (percent: number) => void): Promise<string>;
    /**
     ...
     * @param duplicateFolderOption Option defining how to handle an already existing folder with the same name
     * @param progressCallback (Optional) Function that will be called whenever there is measurable progress (max 1/s)
     ...
     */
    copyFolder(srcFolderPath: string, destFolderPath: string, duplicateFolderOption: DuplicateFolderOption, progressCallback?: (percent: number) => void): Promise<string>;
    /**
     ...
     */
    moveFile(srcFilePath: string, destFilePath: string, duplicateFileOption: DuplicateFileOption, progressCallback?: (percent: number) => void): Promise<string>;
    /**
     * Moves a folder to the specified location.
     * @param srcFolderPath Source folder path
     * @param destFolderPath Destination folder path
     * @param duplicateFolderOption Option defining how to handle an already existing folder with the same name
     * @param progressCallback (optional) callback function that will be called whenever there is measurable progress (max 1/s) (WORK IN PROGRESS)
     ...
     */
    moveFolder(srcFolderPath: string, destFolderPath: string, duplicateFolderOption: DuplicateFolderOption, progressCallback?: (percent: number) => void): Promise<string>;
    /**
     * Renames a file.
     * @param filePath File path WITH file extension
