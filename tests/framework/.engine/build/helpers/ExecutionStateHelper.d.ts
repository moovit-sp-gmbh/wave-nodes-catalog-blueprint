import { ExtendedHigh5ExecutionPackage, High5ExecutionOutcome, High5ExecutionPatchLog, High5ExecutionPatchStatus, High5ExecutionState, StreamRunningNodePatch } from "hcloud-sdk/lib/interfaces/high5/space/execution/index";
...
export default class ExecutionStateHelper {
    ...
    updateProgressAndMessage(runningNodeUpdate: {
        progress?: number;
        message?: string;
