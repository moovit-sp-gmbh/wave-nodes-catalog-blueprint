import { High5ExecutionPackage, High5ExecutionPatchLog, High5ExecutionPatchStatus, StreamNode } from "hcloud-sdk/lib/interfaces/high5/space/execution";
import os from "os";
...
export async function getAgentInfo(executionPackage: High5ExecutionPackage): Promise<AgentInfo> {
    return {
        os: {
